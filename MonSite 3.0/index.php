...
require_once(__ROOT_DIR . '/classes/AutoLoader.class.php'); //charge le myobject donc plus besoin de le charger après
// Reify the current request
$request = Request::getCurrentRequest();
// echo $request->getControllerName(); //si j'ai un truc controlleur dans la requete url
try {
